...
class MENU_mats(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if xp_materials:
            ...
            box.prop(xp_materials, "max_brightness", text="Texture Max Brightness")
            box.prop(xp_materials, "local_max_brightness", text="Local Max Brightness")
            if xp_materials.local_max_brightness == -1:
...
class MENU_operations(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        btn_find_textures_recursive = layout.operator("xp_ext.find_textures", text="Find Missing Textures Recursively")
